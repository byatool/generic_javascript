...
/**
 ...
 @protected
 */
src.base.control.dropDownList.createFillListHandler = function(select, defaultText, fillASelect) {
  return function(result) {
    fillASelect(select, result, defaultText);
  };
};
...
/**
 ...
 @export
 */
src.base.control.dropDownList.initialize = function(controlId, url, parameters, defaultText, getElement, submitData, fillTheList) {
