...
src.test.validation.validationInterpreter.whenInterpretingRules.describe = function() {
    ...
    beforeEach(function() {
        ...
        peek_ = function() { return ''; };
        sink_ = function() { return ''; };
    ...
    var callTheMethod_ = function() {
        var result = Current.interpret(rules_, methodList_, createAValidationCall_, car_, cdr_, peek_, sink_, flatten_);
